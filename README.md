...
# | full\_name | VARCHAR2(200) | Required |

# | national\_id | VARCHAR2(40) | Unique |

# | email | VARCHAR2(200) | Unique |

# | kyc\_status | VARCHAR2(32) | Defaults to `PENDING` |
...
# | customer\_id | NUMBER | FK → CUSTOMER.id |

# | type | VARCHAR2(32) | `SAVINGS` or `CHECKING` |

# | currency | VARCHAR2(3) | e.g. `PEN`, `USD` |

# | opened\_at | TIMESTAMP | Default `SYSTIMESTAMP` |
...
# CREATE USER app\_user IDENTIFIED BY "Omelasuda32#@";

# GRANT CONNECT, RESOURCE TO app\_user;

# ALTER USER app\_user QUOTA UNLIMITED ON USERS;
